...
import (
	...
	v1 "github.com/joshcarp/grpc-vs-connect/connect-codegen/backend/gen/demo/eliza/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ElizaServiceName = "demo.eliza.v1.ElizaService"
)

// ElizaServiceClient is a client for the demo.eliza.v1.ElizaService service.
...
// NewElizaServiceClient constructs a client for the demo.eliza.v1.ElizaService service. By default,
...
// Say calls demo.eliza.v1.ElizaService.Say.
...
// Converse calls demo.eliza.v1.ElizaService.Converse.
...
// Introduce calls demo.eliza.v1.ElizaService.Introduce.
...
// ElizaServiceHandler is an implementation of the demo.eliza.v1.ElizaService service.
...
func NewElizaServiceHandler(svc ElizaServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/demo.eliza.v1.ElizaService/Say", connect_go.NewUnaryHandler(
		"/demo.eliza.v1.ElizaService/Say",
		svc.Say,
		opts...,
	))
	mux.Handle("/demo.eliza.v1.ElizaService/Converse", connect_go.NewBidiStreamHandler(
		"/demo.eliza.v1.ElizaService/Converse",
		svc.Converse,
		opts...,
	))
	mux.Handle("/demo.eliza.v1.ElizaService/Introduce", connect_go.NewServerStreamHandler(
		"/demo.eliza.v1.ElizaService/Introduce",
		svc.Introduce,
		opts...,
	))
	return "/demo.eliza.v1.ElizaService/", mux
}
...
func (UnimplementedElizaServiceHandler) Say(context.Context, *connect_go.Request[v1.SayRequest]) (*connect_go.Response[v1.SayResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("demo.eliza.v1.ElizaService.Say is not implemented"))
}
...
func (UnimplementedElizaServiceHandler) Converse(context.Context, *connect_go.BidiStream[v1.ConverseRequest, v1.ConverseResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("demo.eliza.v1.ElizaService.Converse is not implemented"))
}
...
func (UnimplementedElizaServiceHandler) Introduce(context.Context, *connect_go.Request[v1.IntroduceRequest], *connect_go.ServerStream[v1.IntroduceResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("demo.eliza.v1.ElizaService.Introduce is not implemented"))
}
