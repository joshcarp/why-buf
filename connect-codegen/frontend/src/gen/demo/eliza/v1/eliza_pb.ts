...
// @generated from file demo/eliza/v1/eliza.proto (package demo.eliza.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message demo.eliza.v1.SayRequest
 */
export class SayRequest extends Message<SayRequest> {
  ...
  static readonly typeName = "demo.eliza.v1.SayRequest";
 ...
 *
 * @generated from message demo.eliza.v1.SayResponse
 */
export class SayResponse extends Message<SayResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "demo.eliza.v1.SayResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message demo.eliza.v1.ConverseRequest
 */
export class ConverseRequest extends Message<ConverseRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "demo.eliza.v1.ConverseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message demo.eliza.v1.ConverseResponse
 */
export class ConverseResponse extends Message<ConverseResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "demo.eliza.v1.ConverseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message demo.eliza.v1.IntroduceRequest
 */
export class IntroduceRequest extends Message<IntroduceRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "demo.eliza.v1.IntroduceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message demo.eliza.v1.IntroduceResponse
 */
export class IntroduceResponse extends Message<IntroduceResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "demo.eliza.v1.IntroduceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
